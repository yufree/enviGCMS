...
svaplot <- function(list,
        ...
        posv <-
                cumsum(as.numeric(table(lv) / sum(table(lv))))[1:(nlevels(lv) - 1)]
...
svabatch <- function(df, dfsv, dfanova) {
        ...
        graphics::plot(
                df$PosteriorProbabilitiesSurrogate[big <
        ...
        graphics::points(
                df$PosteriorProbabilitiesSurrogate[big <
                                                           0 &
                                                           dfsv$pqvalues &
                                                           dfanova$pqvalues] ~ df$PosteriorProbabilitiesMod[big <
                                                                                                                    0 & dfsv$pqvalues & dfanova$pqvalue],
                pch = 19,
                col = "red"
        )
        graphics::points(
